...
class ProductSeed {
    async run() {
        const data = [
            {
                ...
                single_variant: true,
                category: await Category_entity_1.Category.findOneOrFail({ where: { id: 4 } }),
                material: await Material_entity_1.Material.findOneOrFail({ where: { id: 4 } })
            },
            {
                id: 2,
            ...
            },
            {
                ...
                single_variant: true,
                category: await Category_entity_1.Category.findOneOrFail({ where: { id: 3 } }),
                material: await Material_entity_1.Material.findOneOrFail({ where: { id: 4 } })
            },
            {
                id: 6,
            ...
            },
            {
                ...
                slug: 'ceren-ring',
                single_variant: true,
                category: await Category_entity_1.Category.findOneOrFail({ where: { id: 1 } }),
                material: await Material_entity_1.Material.findOneOrFail({ where: { id: 4 } })
            },
            {
                id: 10,
            ...
            },
            {
                ...
                single_variant: true,
                category: await Category_entity_1.Category.findOneOrFail({ where: { id: 2 } }),
                material: await Material_entity_1.Material.findOneOrFail({ where: { id: 4 } })
            },
            {
                id: 16,
            ...
            },
            {
                ...
                single_variant: true,
                category: await Category_entity_1.Category.findOneOrFail({ where: { id: 6 } }),
                material: await Material_entity_1.Material.findOneOrFail({ where: { id: 4 } })
            },
            {
                id: 32,
            ...
            },
            {
                ...
                single_variant: true,
                category: await Category_entity_1.Category.findOneOrFail({ where: { id: 2 } }),
                material: await Material_entity_1.Material.findOneOrFail({ where: { id: 2 } })
            },
            {
                id: 35,
                ...
                single_variant: true,
                category: await Category_entity_1.Category.findOneOrFail({ where: { id: 1 } }),
                material: await Material_entity_1.Material.findOneOrFail({ where: { id: 1 } })
            },
            {
                id: 36,
        ...
        const products = Product_entity_1.Product.create(data);
        await Product_entity_1.Product.save(products);
    }
}
