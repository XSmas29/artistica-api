...
class ProductSeed {
    run() {
        return __awaiter(this, void 0, void 0, function* () {
            const data = [
                {
                    ...
                    single_variant: true,
                    category: yield Category_entity_1.Category.findOneOrFail({ where: { id: 4 } }),
                    material: yield Material_entity_1.Material.findOneOrFail({ where: { id: 4 } })
                },
                {
                    id: 2,
                ...
                },
                {
                    ...
                    single_variant: true,
                    category: yield Category_entity_1.Category.findOneOrFail({ where: { id: 3 } }),
                    material: yield Material_entity_1.Material.findOneOrFail({ where: { id: 4 } })
                },
                {
                    id: 6,
                ...
                },
                {
                    ...
                    slug: 'ceren-ring',
                    single_variant: true,
                    category: yield Category_entity_1.Category.findOneOrFail({ where: { id: 1 } }),
                    material: yield Material_entity_1.Material.findOneOrFail({ where: { id: 4 } })
                },
                {
                    id: 10,
                ...
                },
                {
                    ...
                    single_variant: true,
                    category: yield Category_entity_1.Category.findOneOrFail({ where: { id: 2 } }),
                    material: yield Material_entity_1.Material.findOneOrFail({ where: { id: 4 } })
                },
                {
                    id: 16,
                ...
                },
                {
                    ...
                    single_variant: true,
                    category: yield Category_entity_1.Category.findOneOrFail({ where: { id: 6 } }),
                    material: yield Material_entity_1.Material.findOneOrFail({ where: { id: 4 } })
                },
                {
                    id: 32,
                ...
                },
                {
                    ...
                    single_variant: true,
                    category: yield Category_entity_1.Category.findOneOrFail({ where: { id: 2 } }),
                    material: yield Material_entity_1.Material.findOneOrFail({ where: { id: 2 } })
                },
                {
                    id: 35,
                    ...
                    single_variant: true,
                    category: yield Category_entity_1.Category.findOneOrFail({ where: { id: 1 } }),
                    material: yield Material_entity_1.Material.findOneOrFail({ where: { id: 1 } })
                },
                {
                    id: 36,
            ...
            yield Product_entity_1.Product.save(products);
        });
    }
}
